...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "academia holystic huancayo",
    "holystic academy peru",
    "academia de refuerzo académico",
    "holystic college",
    "preparación escolar huancayo",
    "colegio san jeronimo huancayo",
    "colegio holystic",
    "clases preuniversitarias huancayo",
    "ingresantes universidad Huancayo",
    "Juan Suazo",
    "Física y Aritmética",
    "Adrián Córdova",
    "Física Experimental",
